...
| 2.4 | Integrate with `parallel_tasks` — mission tasks auto-dispatch | ✅ | `internal/agent/mission_tool.go` (dispatch action) |
| 2.5 | Add mission status dashboard (CLI + desktop) | ✅ | `internal/control/controller.go` (/mission command) |
